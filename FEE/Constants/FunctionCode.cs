...
namespace UTEHY.Model.Constants
{
    public class FunctionCode
    {
        ...
        public const string CONTENT_TAG = "CONTENT_TAG";

        public const string STATISTIC = "STATISTIC";
        public const string STATISTIC_CONTACT = "STATISTIC_ONLINE";
        ...
        public const string MORE_MENU = "MORE_MENU";
        public const string MORE_IMAGE = "MORE_IMAGE";
        public const string MORE_PARTNER = "MORE_PARTNER";
    }
}
